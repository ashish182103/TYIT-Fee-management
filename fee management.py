...
def open_fee_management():
    ...
    a = Label(window,text="Student Id:",font=('Georgia',18,'bold'))
    a.place(x=700,y=120)
    b = Label(window,text ="Name Of Std:     ",font=('Georgia',18,'bold'))
    b.place(x=700,y=160)
    c = Label(window,text="Class:                   ",font=('Georgia',18,'bold'))
    c.place(x=700,y=210)
    d = Label(window ,text = "Division :",font=('Georgia',18,'bold'))
    d.place(x=700,y=260)
    e = Label(window ,text = "Date Of Birth:",font=('Georgia',18,'bold'))
    e.place(x=700,y=310)
    f = Label(window ,text = "Roll No:                ",font=('Georgia',18,'bold'))
    f.place(x=700,y=360)
    g = Label(window ,text = "Gender:             ",font=('Georgia',18,'bold'))
    g.place(x=700,y=410)
    a1 = Entry(window )
    a1.place(x=900,y=120)
    b1 = Entry(window )
    b1.place(x=900,y=160)
    c1 = Entry(window)
    c1.place(x=900,y=210)
    d1 = Entry(window )
    d1.place(x=900,y=260)
    e1 = Entry(window)
    e1.place(x=900,y=310)
    f1 = Entry(window )
    f1.place(x=900,y=360)
    g1 = Entry(window )
    g1.place(x=900,y=410)
